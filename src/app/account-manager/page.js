...
import DeleteAccountManager from "@/components/DeleteAccountManager"
...
export default function Page() {
    ...
    ;(async () => {
      if (
        ...
        if (loginUserRole == "Super Admin") {
          ...
          // setAccountManagers(accountManager)
          setAccountManagers([...accountManager].sort((a, b) => (a.name < b.name ? -1 : 1)))
          setNameAccendingOrderActive(true)
          setNameDecendingOrderActive(false)
        } else if (loginUserRole == "Account Manager") {
          const accountManager = await getSingleAccountManagers()
          // setAccountManagers(accountManager)
          setAccountManagers([...accountManager].sort((a, b) => (a.name < b.name ? -1 : 1)))
          setNameAccendingOrderActive(true)
          setNameDecendingOrderActive(false)
  ...
  const getSingleAccountManagers = async () => {
    let accountManagerId = loginUserId
    let data = await fetch(
      `${NEXT_PUBLIC_url}/api/super-admin/account-manager/${accountManagerId}`,
      {
        cache: "no-cache",
      }
    )
  ...
  // ======================================================
  const addAccountManager = async (e) => {
    e.preventDefault()
    if (
      !name ||
      !email ||
      ...
      if (password == rePassword) {
        let result = await fetch(`${NEXT_PUBLIC_url}/api/super-admin/account-manager`, {
          method: "POST",
          body: JSON.stringify({
            name,
            email,
        ...
        if (result.invalidRole == false) {
          ...
          alert("New Account Manager Added")
          setName("")
          setEmail("")
          setPassword("")
          setRePassword("")
  ...
  // ======================================================
  const editAccountManager = async (
    _id,
    name,
    email,
    password,
  ...
  const updateAccountManager = async (e) => {
    e.preventDefault()
    if (
      !name ||
      !email ||
      ...
      if (data.invalidRole == false) {
        ...
        alert("Account Manager has been Updated")
  ...
  const nameAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.name < b.name ? -1 : 1)))
    setNameAccendingOrderActive(true)
    setNameDecendingOrderActive(false)
  ...
  const emailAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.email < b.email ? -1 : 1)))
  ...
  const mobileNumberAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.mobileNumber < b.mobileNumber ? -1 : 1)))
  ...
  const companyNameAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.companyName < b.companyName ? -1 : 1)))
  ...
  const countryNameAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.countryName < b.countryName ? -1 : 1)))
  ...
  const stateNameAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.stateName < b.stateName ? -1 : 1)))
  ...
  const cityNameAccendingOrder = (e) => {
    e.preventDefault()
    setAccountManagers([...accountManagers].sort((a, b) => (a.cityName < b.cityName ? -1 : 1)))
  ...
  return (
    <div>
      ...
      <div className="accountManager">
        ...
        <div className="accountManagerSection">
          <div className="accountManagerInnerSection">
            {/* Navbar */}
            <Navbar />

            {/* Navigation */}
            {/* <Navigation page="Account Manager" /> */}

            {/* Add Manager Button */}
            {loginUserRole == "Super Admin" && (
              <AddButton page="Account Manager" name="+ Add Manager" setShowModal={setShowModal} />
            )}
                ...
                <table>
                  <thead>
                    <tr>
                      ...
                      {/* <th>Mobile Number</th> */}
                      {mobileNumberAccendingOrderActive == false && mobileNumberDecendingOrderActive == true ? (
                      ...
                      {/* <th>Company Name</th> */}
                      {companyNameAccendingOrderActive == false && companyNameDecendingOrderActive == true ? (
                      ...
                      {/* <th>Country</th> */}
                      {countryNameAccendingOrderActive == false && countryNameDecendingOrderActive == true ? (
                      ...
                      {/* <th>State</th> */}
                      {stateNameAccendingOrderActive == false && stateNameDecendingOrderActive == true ? (
                      ...
                      {/* <th>City</th> */}
                      {cityNameAccendingOrderActive == false && cityNameDecendingOrderActive == true ? (
                      ...
                      accountManagers
                        ...
                        .map((item, index) => (
                          <tr key={index}>
                            ...
                            ((loginUserRole == "Account Manager" && loginUserId == item._id) ||
                              loginUserRole == "Super Admin") ? (
                              <>
                                <td className="tableAction">
                                  ...
                                  <DeleteAccountManager id={item._id} />
                                </td>
                              </>
                            ) : (
                              ""
          ...
          <div className="addFormInnerSection">
            <form className="addForm">
              ...
              <div className="addModalBtnSection">
                <button type="submit" onClick={(e) => addAccountManager(e)} className="addModalBtn">
                  + Add Manager
                </button>
              </div>
            </form>
      ...
      {/* Update Account Manager Modal */}
      <Modal show={editShawModal} onClose={() => closeBtn()}>
        {/* Update Account Manager Form */}
        <div className="updateTitle">
          <p>Update Account Manager</p>
        </div>
          ...
          <div className="updateFormInnerSection">
            <form className="updateForm">
              ...
              <div className="updateModalBtnSection">
                <button
                  type="submit"
                  onClick={(e) => updateAccountManager(e)}
